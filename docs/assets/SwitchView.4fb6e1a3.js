import{d as y,l as N,s as i,D as j,o as S,c as C,a as s,B as P,E as U,n as h,q,r as v,e as t,t as k,w as m,f as n,m as M}from"./vendor.6a66068f.js";import{C as z}from"./CodeBlock.75e3803d.js";import{P as R}from"./PropsTable.bb7bb3aa.js";import{E as W}from"./EventsTable.9c9b35c6.js";import{_ as A,N as G}from"./NextBar.999c92da.js";import{C as H}from"./CodeButton.b60baf0a.js";function I(){const e=function(){return((1+Math.random())*65536|0).toString(16).substring(1)};return e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e()}var F=(e,l)=>{for(const[r,u]of l)e[r]=u;return e};const J=y({props:{checked:{type:Boolean,default:null},big:{type:Boolean,default:!1},value:{type:Boolean,default:null}},emits:["update:value","change"],setup(e,{emit:l}){const{checked:r,value:u}=N(e),d=i(!1),w=I();function o(){l("change",d.value),l("update:value",d.value)}return j(()=>{if(u.value!==null){d.value=u.value;return}r.value!==null&&(d.value=r.value)}),{onChange:o,isChecked:d,sid:w}}}),K={class:"inline-block sw-switch",style:{"background-color":"transparent",color:"inherit"}},L=["for"],O={class:"relative"},Q=["id","checked"];function X(e,l,r,u,d,w){return S(),C("div",K,[s("label",{for:"toggle"+e.sid,class:"flex items-center cursor-pointer"},[s("div",O,[P(s("input",{id:"toggle"+e.sid,type:"checkbox",class:"sr-only",checked:e.isChecked,"onUpdate:modelValue":l[0]||(l[0]=o=>e.isChecked=o),onChange:l[1]||(l[1]=o=>e.onChange())},null,40,Q),[[U,e.isChecked]]),s("div",{class:h(["block rounded-full bg",{big:e.big===!0}])},null,2),s("div",{class:h(["absolute transition rounded-full dot left-1 top-1",{big:e.big===!0}])},null,2)]),q(e.$slots,"default")],8,L)])}var Y=F(J,[["render",X]]);const Z=y({components:{CodeBlock:z,PropsTable:R,EventsTable:W,SwSwitch:Y,NextBar:G,CodeButton:H},setup(){const e=`
