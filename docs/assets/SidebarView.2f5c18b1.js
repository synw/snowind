import{d as $,l as V,q as g,D as W,E as A,G as C,H as j,o as l,c as i,s as R,n as O,I as z,J as H,r as x,a as o,e as v,w as E,t as F,F as L,p as U,k as q,f as m,m as G,j as w}from"./vendor.36fa6795.js";import{C as J}from"./CodeBlock.dcc9d3c4.js";import{N as M}from"./NextBar.395fabf9.js";import{P as K}from"./PropsTable.7bfffcca.js";import{_ as Q}from"./index.30def6f8.js";var X=Object.defineProperty,Y=(e,s,t)=>s in e?X(e,s,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[s]=t,Z=(e,s,t)=>(Y(e,typeof s!="symbol"?s+"":s,t),t);function ee(e){return z()?(H(e),!0):!1}const se=typeof window!="undefined",te=e=>typeof e=="string",N=()=>{};function ae(e,s){function t(...a){e(()=>s.apply(this,a),{fn:s,thisArg:this,args:a})}return t}const oe=e=>e();var T=Object.getOwnPropertySymbols,re=Object.prototype.hasOwnProperty,le=Object.prototype.propertyIsEnumerable,ie=(e,s)=>{var t={};for(var a in e)re.call(e,a)&&s.indexOf(a)<0&&(t[a]=e[a]);if(e!=null&&T)for(var a of T(e))s.indexOf(a)<0&&le.call(e,a)&&(t[a]=e[a]);return t};function ne(e,s,t={}){const a=t,{eventFilter:r=oe}=a,d=ie(a,["eventFilter"]);return j(e,ae(r,s),d)}const P=se?window:void 0;function de(...e){let s,t,a,r;if(te(e[0])?([t,a,r]=e,s=P):[s,t,a,r]=e,!s)return N;let d=N;const h=j(()=>C(s),f=>{d(),!!f&&(f.addEventListener(t,a,r),d=()=>{f.removeEventListener(t,a,r),d=N})},{immediate:!0,flush:"post"}),c=()=>{h(),d()};return ee(c),c}const ce={boolean:{read:e=>e==="true",write:e=>String(e)},object:{read:e=>JSON.parse(e),write:e=>JSON.stringify(e)},number:{read:e=>Number.parseFloat(e),write:e=>String(e)},any:{read:e=>e,write:e=>String(e)},string:{read:e=>e,write:e=>String(e)}};function pe(e,s,t=(r=>(r=P)==null?void 0:r.localStorage)(),a={}){var r;const{flush:d="pre",deep:h=!0,listenToStorageChanges:c=!0,window:f=P,eventFilter:k,onError:p=b=>{console.error(b)}}=a,u=C(s),D=u==null?"any":typeof u=="boolean"?"boolean":typeof u=="string"?"string":typeof u=="object"||Array.isArray(u)?"object":Number.isNaN(u)?"any":"number",_=g(s),S=(r=a.serializer)!=null?r:ce[D];function I(b){if(!(!t||b&&b.key!==e))try{const y=b?b.newValue:t.getItem(e);y==null?(_.value=u,u!==null&&t.setItem(e,S.write(u))):_.value=S.read(y)}catch(y){p(y)}}return I(),f&&c&&de(f,"storage",I),t&&ne(_,()=>{try{_.value==null?t.removeItem(e):t.setItem(e,S.write(_.value))}catch(b){p(b)}},{flush:d,deep:h,eventFilter:k}),_}var B;(function(e){e.UP="UP",e.RIGHT="RIGHT",e.DOWN="DOWN",e.LEFT="LEFT",e.NONE="NONE"})(B||(B={}));class fe{constructor(s=!1){Z(this,"isOpened",pe("isOpened",!0)),this.isOpened.value=s}}var ue=(e,s)=>{for(const[t,a]of s)e[t]=a;return e};const be=$({props:{opened:{type:Boolean,required:!0}},emits:["update:opened"],setup(e,{emit:s}){const{opened:t}=V(e),a=new fe;let r=g(!1);return W(()=>{r.value===!0&&(t.value===!0?a.isOpened.value=!0:t.value===!1&&(a.isOpened.value=!1))}),A(()=>{s("update:opened",a.isOpened.value),r.value=!0}),{model:a}}});function ve(e,s,t,a,r,d){return l(),i("div",{class:O([{opened:e.model.isOpened.value===!0},"sw-sidebar slide-x"])},[R(e.$slots,"default")],2)}var me=ue(be,[["render",ve]]);const he=$({components:{SwSidebar:me,CodeBlock:J,NextBar:M,PropsTable:K},setup(){const e=g(!0),s=g(!0),t=g(!0),a=g(!0);return{sidebar:e,sidebar2:s,collapse1:t,collapse2:a,code1:`
