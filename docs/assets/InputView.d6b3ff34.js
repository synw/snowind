import{C as f}from"./CodeBlock.8e63f17f.js";import{S as w}from"./input.es.b6ee6404.js";import{C as h}from"./CodeButton.18610415.js";import{_ as b}from"./index.9c82c8e6.js";import{d as _,q as k,A as $,r as n,o as u,c as m,a as o,e as t,n as V,F as g,f as d,m as D}from"./vendor.ba3950ab.js";import{N as U}from"./NextBar.2221aae1.js";import{P as S}from"./PropsTable.17bf438c.js";import{E as j}from"./EventsTable.7b94a55d.js";const E=_({components:{CodeBlock:f,SwInput:w,CodeButton:h},setup(){const e=k(!0);return{form:$({name:{val:"",isValid:null,validator:l=>l.length>2}}),code1:`
      <sw-input
        id="username"
    ...
    `,collapse:e}}}),N={id:"form"},x={class:"mt-3 text-sm"},L={key:0,class:"text-success dark:text-success-dark"},P={key:1,class:"text-danger dark:text-danger-dark"},z={key:2,class:"text-neutral dark:text-neutral-dark"},A=d(" Template: "),F=d("Script: "),O=o("div",{class:"mt-5"},[d(" The input field has a tristate: "),o("code",{class:"variable"},"null"),d(" : nothing has been edited, "),o("code",{class:"variable"},"false"),d(": invalid input and "),o("code",{class:"variable"},"true"),d(": valid input ")],-1);function H(e,a,c,v,l,y){const i=n("sw-input"),r=n("code-block"),p=n("code-button");return u(),m(g,null,[o("div",N,[t(i,{id:"form-username",value:e.form.name.val,"onUpdate:value":a[0]||(a[0]=s=>e.form.name.val=s),isvalid:e.form.name.isValid,"onUpdate:isvalid":a[1]||(a[1]=s=>e.form.name.isValid=s),validator:e.form.name.validator,placeholder:"username",required:""},null,8,["value","isvalid","validator"]),o("div",x,[e.form.name.isValid===!0?(u(),m("div",L,"Ok")):e.form.name.isValid===!1?(u(),m("div",P,"Type 3 characters minimum")):(u(),m("div",z,"Type a username"))])]),o("div",{class:V([{"slide-y":!0,slideup:e.collapse===!0,slidedown:e.collapse===!1},"mt-4"])},[A,t(r,{code:e.code1,class:"my-3"},null,8,["code"]),F,t(r,{code:e.code2,lang:"typescript",class:"mt-3"},null,8,["code"])],2),t(p,{class:"mt-3",collapse:e.collapse,onToggle:a[2]||(a[2]=s=>e.collapse=!e.collapse)},null,8,["collapse"]),O],64)}var T=b(E,[["render",H]]);const M=_({components:{CodeBlock:f,SwInput:w,CodeButton:h},setup(){const e=k(!0);return{form:$({name:{val:"",isValid:null,validator:l=>l.length>=3},password:{val:"",isValid:!1,validator:l=>l.length>=6}}),code1:`
    <sw-input
      v-model:value="form.name.val"
      v-model:isvalid="form.name.isValid"
      :validator="form.name.validator"
