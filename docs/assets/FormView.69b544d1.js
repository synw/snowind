import{C as f}from"./CodeBlock.75e3803d.js";import{S as w}from"./input.es.2500a53a.js";import{_ as h,N as V}from"./NextBar.999c92da.js";import{d as y,A as b,v as g,r,o as t,c as o,a as e,e as d,n as _,f as v}from"./vendor.6a66068f.js";const k=y({components:{CodeBlock:f,SwInput:w,NextBar:V},setup(){const s=b({name:{val:"",isValid:null,validator:l=>l.length>2},password:{val:"",isValid:null,validator:l=>l.length>7}}),a=g(()=>s.name.isValid===!0&&s.password.isValid===!0);return{form:s,code1:`
      <sw-input
