import{A as k}from"./AnchorTitle.7cc18ebe.js";import{C as V}from"./CodeBlock.b2d3cbae.js";import{P as _}from"./PropsTable.78bac57d.js";import{N as x}from"./NextBar.270ccf12.js";import{C as B}from"./CodeButton.489f02ad.js";import{d as v,l as N,s as m,G as j,o as h,c as y,a as o,q as P,n as b,r as d,e as i,w as g,F as S,f,m as D}from"./vendor.d513a3f4.js";import{_ as A}from"./index.6acf82f6.js";function w(s,t=!1,e="Timeout"){return new Promise((a,n)=>{setTimeout(t?()=>n(e):a,s)})}var q=(s,t)=>{const e=s.__vccOpts||s;for(const[a,n]of t)e[a]=n;return e};const I=v({props:{show:{type:Boolean,required:!0},delay:{type:Number,default:1500},transitionDelay:{type:Number,default:300}},setup(s){const{show:t,delay:e,transitionDelay:a}=N(s),n=m(t.value),c=["translate-y-24","transform-gpu","opacity-100","transition-none"],r=m(c);function p(){r.value=["transition-opacity","opacity-0"]}function T(){r.value=["ease-in","transform-gpu","translate-y-0"]}async function u(){n.value=!0,T(),await w(a.value),await w(e.value),p(),await w(a.value),r.value=c,n.value=!1}return j(async()=>{t.value===!0&&await u()}),{showToast:n,transitionClass:r}}}),z={class:"toast-content"};function E(s,t,e,a,n,c){return h(),y("div",{class:b(["fixed inset-x-0 px-5 py-2 mx-auto text-sm duration-300 rounded-xl bottom-12 w-max",s.transitionClass.join(" ")])},[o("div",z,[P(s.$slots,"default")])],2)}var F=q(I,[["render",E]]);const O=()=>{const s=m(!1);return{isToastVisible:s,popToast:async(e=1e3)=>{s.value=!0,await new Promise(a=>setTimeout(a,e)),s.value=!1}}},G=v({components:{CodeBlock:V,PropsTable:_,NextBar:x,CodeButton:B,SwToast:F,AnchorTitle:k},setup(){const s=[{prop:"show",description:"The isToastVisible ref from useToast",type:"boolean",values:"true, false",required:!0},{prop:"delay",description:"The number of milliseconds the message will stay visible",type:"number",default:"1500"},{prop:"transition-delay",description:"The duration in milleseconds of the animations",type:"number",default:"300"}],{popToast:t,isToastVisible:e}=O(),a=m(!0),n=m("success");function c(u){n.value=u,t()}return{code1:`
