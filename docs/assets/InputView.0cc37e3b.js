import{C as f}from"./CodeBlock.c5949998.js";import{S as w}from"./input.es.da02a4bd.js";import{C as h}from"./CodeButton.41343d29.js";import{_ as b}from"./index.fc971e03.js";import{d as _,s as k,A as $,r as n,o as u,c as m,a as o,e as t,n as V,F as g,f as i,m as D}from"./vendor.d513a3f4.js";import{N as U}from"./NextBar.bfefa88f.js";import{P as S}from"./PropsTable.a5a2a46c.js";import{E as j}from"./EventsTable.656b6228.js";const E=_({components:{CodeBlock:f,SwInput:w,CodeButton:h},setup(){const e=k(!0);return{form:$({name:{val:"",isValid:null,validator:l=>l.length>2}}),code1:`
      <sw-input
        id="username"
    ...
    `,collapse:e}}}),N={id:"form"},x={class:"mt-3 text-sm"},L={key:0,class:"text-success dark:text-success-dark"},P={key:1,class:"text-danger dark:text-danger-dark"},z={key:2,class:"text-neutral dark:text-neutral-dark"},A=i(" Template: "),F=i("Script: "),O=o("div",{class:"mt-5"},[i(" The input field has a tristate: "),o("code",{class:"variable"},"null"),i(" : nothing has been edited, "),o("code",{class:"variable"},"false"),i(": invalid input and "),o("code",{class:"variable"},"true"),i(": valid input ")],-1);function H(e,a,c,v,l,y){const d=n("sw-input"),r=n("code-block"),p=n("code-button");return u(),m(g,null,[o("div",N,[t(d,{id:"form-username",value:e.form.name.val,"onUpdate:value":a[0]||(a[0]=s=>e.form.name.val=s),isvalid:e.form.name.isValid,"onUpdate:isvalid":a[1]||(a[1]=s=>e.form.name.isValid=s),validator:e.form.name.validator,placeholder:"username",required:""},null,8,["value","isvalid","validator"]),o("div",x,[e.form.name.isValid===!0?(u(),m("div",L,"Ok")):e.form.name.isValid===!1?(u(),m("div",P,"Type 3 characters minimum")):(u(),m("div",z,"Type a username"))])]),o("div",{class:V([{"slide-y":!0,slideup:e.collapse===!0,slidedown:e.collapse===!1},"mt-4"])},[A,t(r,{code:e.code1,class:"my-3"},null,8,["code"]),F,t(r,{code:e.code2,lang:"typescript",class:"mt-3"},null,8,["code"])],2),t(p,{class:"mt-3",collapse:e.collapse,onToggle:a[2]||(a[2]=s=>e.collapse=!e.collapse)},null,8,["collapse"]),O],64)}var T=b(E,[["render",H]]);const M=_({components:{CodeBlock:f,SwInput:w,CodeButton:h},setup(){const e=k(!0);return{form:$({name:{val:"",isValid:null,validator:l=>l.length>=3},password:{val:"",isValid:!1,validator:l=>l.length>=6}}),code1:`
    <sw-input
      v-model:value="form.name.val"
      v-model:isvalid="form.name.isValid"
      :validator="form.name.validator"
