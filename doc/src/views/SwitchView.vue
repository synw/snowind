...
import { SwSwitch, SwCollapse, SwCollapseModel } from "@/snowind";
...
export default defineComponent({
  ...
  setup() {
    ...
    const collapse3 = new SwCollapseModel();
    const collapse4 = new SwCollapseModel();
    const collapse5 = new SwCollapseModel();
